...
namespace Microsoft.AspNetCore.Mvc.RazorPages
{
    ...
    public class RazorPagesOptions : IEnumerable<ICompatibilitySwitch>
    {
        ...
        private readonly CompatibilitySwitch<bool> _allowFuzzyHttpMethodMatching;
        ...
        public RazorPagesOptions()
        {
            ...
            _allowFuzzyHttpMethodMatching = new CompatibilitySwitch<bool>(nameof(AllowFuzzyHttpMethodMatching));

            _switches = new ICompatibilitySwitch[]
            {
                _allowAreas,
                _allowFuzzyHttpMethodMatching,
            };
        }
        ...
        /// by GET and POST handler methods. This allows a GET handler methods to accept the HEAD, TRACE, and OPTIONS
        /// HTTP methods in addition to GET. A POST handler method can handle all other HTTP methods. Handler methods
        /// can still be defined to accept specific methods such as HEAD or PUT, and the most specific handler will
        /// be invoked.
        /// </para>
        /// <para>
        ...
        /// </para>
        /// </remarks>
        public bool AllowFuzzyHttpMethodMatching
        {
            get;
            set;
        }

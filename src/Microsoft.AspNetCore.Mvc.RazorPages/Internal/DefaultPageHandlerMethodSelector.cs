...
namespace Microsoft.AspNetCore.Mvc.RazorPages.Infrastructure
{
    public class DefaultPageHandlerMethodSelector : IPageHandlerMethodSelector
    {
        ...
        private bool AllowFuzzyHttpMethodMatching => _options?.Value.AllowFuzzyHttpMethodMatching ?? false;
        ...
        private static string GetFuzzyMatchHttpMethod(PageContext context)
        {
            ...
            // All of the 'safe' HTTP methods map to GET
            if (string.Equals("GET", httpMethod, StringComparison.OrdinalIgnoreCase) ||
                ...
                string.Equals("TRACE", httpMethod, StringComparison.OrdinalIgnoreCase))
            {
                return "GET";
            }

            // Anything else maps to POST.
            return "POST";
        }
    }
}